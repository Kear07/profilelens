const translations = {
  pt: {
    ...
    demoTitle: 'Modo demonstracao',
    demoDesc: 'Veja como funciona a analise com dados de exemplo. Nenhuma API key necessaria.',
    demoBtn: 'Ver exemplo',
    demoHint: 'Configure uma API key em Configuracoes para analisar seu perfil real',
    pdfLockedTooltip: 'Upload de PDF requer uma IA conectada. Clique em {settings} (topo direito) e escolha Gemini (gratis) ou Custom.',
    pdfReady: '✓ PDF pronto',
...
React, Node.js, TypeScript, Python, AWS, Docker`,
    ...
    textNotLinkedin: 'Este texto não parece ser um perfil LinkedIn. Cole o conteudo do seu perfil (headline, sobre, experiencia, habilidades).',
    ...
    providerGeminiDesc: '2.5 Flash (gratis), 2.5 Pro, 3.x Preview',
    providerCustomName: 'Custom (OpenAI-compatible)',
    providerCustomDesc: 'Qualquer API compativel com formato OpenAI',
